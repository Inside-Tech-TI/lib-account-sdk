...
class OTPService {
    ...
    static generateQRCodeUri(secret, issuer, accountName) {
        return __awaiter(this, void 0, void 0, function* () {
            return otplib_1.authenticator.keyuri(accountName, issuer, secret);
        });
    }
    static generateQRCode(secret, issuer, accountName) {
        return __awaiter(this, void 0, void 0, function* () {
            const otpauthUrl = yield this.generateQRCodeUri(accountName, issuer, secret);
            return yield QRCode.toDataURL(otpauthUrl);
        });
    }
